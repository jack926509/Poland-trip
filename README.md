...
`sw.js` 是 Service Worker（目前 `polska-v5`），在 `main.js` 載入後註冊：
...
修改 `sw.js` 時記得提升 `CACHE_VERSION`（如 `polska-v5` → `polska-v6`），舊快取會在啟用時清除，並讓使用者看到更新提示。
...
| 2 | 10/25（日） | 華沙 → 克拉科夫 | 09:00 EIP Pendolino 南下（2h25）· 下午老城三大景點：中央市集、聖瑪利教堂、瓦維爾城堡 |
| 3 | 10/26（一） | 克拉科夫 ⇄ Auschwitz | Lajkonik 巴士來回 · 全天奧斯威辛 · 晚上回 Kazimierz 猶太區晚餐 |
| 4 | 10/27（二） | 克拉科夫 → 弗羅茨瓦夫 | 上午辛德勒工廠博物館 · 下午鹽礦或自由時光 · 17:30 IC 北上（3h30）|
| 5 | 10/28（三） | 弗羅茨瓦夫 → 波茲南 | 上午 700 小矮人尋寶 + 全景畫 · 13:00 出發百年廳 · 傍晚座堂島煤氣燈 · 19:00 IC 北上（2h20）|
| 6 | 10/29（四） | 波茲南 → 華沙 | 上午教堂島 + 12:00 山羊鐘樓秀 · 下午聖馬丁牛角麵包 · 17:30 EIP 東返（2h45）|
| 7 | 10/30（五） | 華沙 | POLIN 猶太博物館 · 起義博物館 · 蕭邦博物館 · 老城晚餐 |
...
|---|---|---|
| 機票（已開票） | — | 國泰 + 卡達 + 長榮聯運 |
| 住宿 7 晚 | 14,000 – 21,000 | 平均每晚 2k–3k，老城邊精品 / 商務 |
| 跨城火車 5 段 | 3,500 – 5,000 | EIP + IC 共 5 段，提前 1–2 個月最便宜 |
| 餐費 | 6,000 – 9,000 | 早餐旅館 / 中午 Bar Mleczny / 晚上正餐 |
| 門票 | 2,000 – 3,000 | Auschwitz、辛德勒、POLIN、瓦維爾 等 |
