...
原資料共有 24 個地址群組，其中 9 組把兩間門市寫在同一筆。本輪拆成 **33 間單店**：18 間可由品牌官方門市頁或官方 locator 直接確認地址（17 間 verified、1 間地址核實但時段待確認的 partial），15 間因官方 locator 無法逐店重現而保留為 `pending`。`pending` 不帶查核日，營業時間統一寫「待確認」，沒有以購物中心或第三方頁面代替品牌官方證據。
