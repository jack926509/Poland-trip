# 來源規格原文：Mostar cinematic scroll page

> **這是使用者於 2026-08-01 提供的第三方建置規格原文，逐字保存。**
> 實作時所有數值以本檔為唯一權威來源。
> 內容層的波蘭置換規則見 `2026-08-01-cinematic-scroll-reference-design.md` §3.3。
> 本檔請勿改寫、勿「順手修正」，它是對照基準。
