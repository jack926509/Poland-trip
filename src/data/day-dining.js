  ...
  "1": [
    {
      ...
      "note": "皇家大道散步後的波蘭料理；與原訂 Zapiecek 擇一。",
    ...
    },
    {
      ...
      "note": "老城店，馬鈴薯糰與牛肚湯；抵達後依胃口擇一餐，週六營業時間待確認。",
  ...
  "2": [
    {
      ...
      "note": "辛德勒工廠後回 Kazimierz 吃 zapiekanka。",
      "map": "https://www.google.com/maps/search/?api=1&query=Endzior%20Plac%20Nowy%2C%20Krak%C3%B3w"
    },
    {
      "role": "工廠後替補",
      "name": "Hankki",
      "address": "Zabłocie 19A, Kraków",
      "note": "韓日料理；不想再回 Kazimierz 吃正餐時替換 Endzior，確認當晚收客時間。",
    ...
    },
    {
      ...
      "note": "牛奶吧；若午餐改在老城往 Wawel 途中可選，先確認週日營業。",
  ...
  "3": [
    {
      ...
      "note": "地窖波蘭料理；每日 13:00 起，建議預約回程後的晚餐。",
    ...
    },
    {
      ...
      "note": "以色列分享料理；週一 16:00 起，與 Pod Aniołami 擇一。",
  ...
  "4": [
    {
      ...
      "note": "車站附近的烏茲別克／喬治亞料理。週二廚房公告至 22:00；參考 20:52 抵站後須確認最後點餐，延誤改簡餐。",
  ...
  "5": [
    {
      ...
      "note": "地方波蘭料理，可試 hekele、地方風格 bigos。須先挪出完整午餐時間，不能直接塞在全景畫與百年廳之間。",
    ...
    },
    {
      ...
      "note": "區域料理，建議訂位並單點；六道套餐 209 PLN，葡萄酒搭配另加 169 PLN（現行菜單）。",
    ...
    },
    {
      ...
      "note": "週三 13:00 才開門；需調整百年廳時段才能安排，訂位不保證快速出餐。",
      "map": "https://www.google.com/maps/search/?api=1&query=Konspira%20Plac%20Solny%2011%2C%20Wroc%C5%82aw"
    },
    {
      "role": "咖啡短停",
      "name": "El Gato Specialty Coffee Roasters",
      "address": "Odrzańska 8/1, Wrocław",
      "note": "老城散步途中喝咖啡，依當天時間停留。",
  ...
  "6": [
    {
      ...
      "note": "馬鈴薯地方料理；看山羊後安排，需配合牛角麵包博物館實際場次。",
    ...
    },
    {
      ...
      "note": "週四 11:00 起；想吃鴨肉與地方料理可選，但需重排動線，不要吃完趕正午山羊秀。",
    ...
    },
    {
      ...
      "note": "靠近 Metropol 的韓式換口味選項；約 20:30 用餐，出發前確認最後點餐。",
  ...
  "7": [
    {
      ...
      "note": "起義博物館後的斯拉夫料理，建議訂位；可替換原訂 U Fukiera／Polka，若選這裡不必特地回老城吃飯。",
    ...
    },
    {
      ...
      "note": "想體驗套餐時取代 WYRAJ，預留完整晚間並向店家確認現址、時間與訂位。",
