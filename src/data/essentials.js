...
export const preDepartureNotes = [
  ...
  '樂斯拉夫百年廳圓頂展廳——官方 availability calendar 逐日標三種狀態：可進圓頂大廳／圓頂大廳部分時段不開但 Visitor Centre 可參觀／兩者皆不開。2026-09-17 讀取官方日曆時只取得到當月頁面，10/28 屬哪一種仍未確認；未確認前主行程只排外觀與周邊，行前 3–5 天再上 halastulecia.pl 複查。',
];
