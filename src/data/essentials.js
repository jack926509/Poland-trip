...
export const preDepartureNotes = [
  ...
  '先訂清單——奧斯威辛 10/26 10:30 英文導覽已訂妥（入場須同時出示入場證與證件）；仍待處理：Lajkonik 10/26 往返巴士（班次已查、尚未購票）、Wieliczka 10/27 英語場（票價 143／121 已查、場次與庫存未確認）、辛德勒工廠（muzeumkrakowa.pl）、四段城際火車、米其林餐廳。',
