...
export const days = [
  ...
  },
  {
    ...
    warn: '❗此日兩項皆尚未訂票。全景畫 11:30 場已查到但尚未購票；午餐已確認 12:00 開門，仍須確認出餐速度。百年廳 10/28 已查為藍色日，可看 Visitor Centre，但 14:00 廳內開放不保證。10/28 日落約 16:34；點燈人沒有對外保證的固定出發分鐘，因此安排 16:15–17:15 在座堂島等候。',
    backup: [
...
export const deadlines = [
  ...
  },
  {
    ...
    status: '藍色日已查／行前複查', url: 'https://halastulecia.pl/zwiedzanie/kalendarz-dostepnosci/',
