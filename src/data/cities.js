...
// lightPhase 宣告這個構圖預期的光線階段（daylight／goldenHour／dusk／night），
// 由 tools/audit-schedule.mjs 拿去跟 essentials.js 的當日日落對照——10 月底日落在
// 16:00 上下，「黃昏斜光」這種描述很容易在換季後就不再成立。
...
export const photoSpots = [
  {id:'waw-oldtown', lightPhase:'goldenHour', cityKey:'WAW', name:'老城市集廣場彩色立面', day:1, bestTime:'16:45–17:15', viewpoint:'華沙美人魚像西南側約 10 公尺，靠 Dekert Side 一側', direction:'鏡頭朝東北，先以 24–35 mm 收整排彩色立面，再退到拱廊邊拍廣場全景', light:'日落前的斜側光會打在北、東側立面；避免貼著雕像仰拍造成建築傾斜。', mapUrl:'https://www.google.com/maps/search/?api=1&query=52.249778%2C21.012151'},
  {id:'waw-castle', lightPhase:'goldenHour', cityKey:'WAW', name:'城堡廣場與皇家城堡', day:1, bestTime:'16:30–17:00', viewpoint:'齊格蒙特三世紀念柱西側、靠 Krakowskie Przedmieście 的廣場邊緣', direction:'鏡頭朝東北，把紀念柱放左側、皇家城堡紅牆放右側；直幅可同時收柱頂與城堡', light:'低角度光讓城堡紅牆更飽和；廣角請保持手機水平，避免紀念柱向後倒。', mapUrl:'https://www.google.com/maps/search/?api=1&query=52.247604%2C21.013455'},
  ...
  {id:'poz-tumski', lightPhase:'daylight', cityKey:'POZ', name:'Jordan 橋上的波茲南主教座堂', day:6, bestTime:'09:00–10:30', viewpoint:'Most Biskupa Jordana 橋東側約三分之一處，靠 Śródka 一端', direction:'鏡頭朝西南，以橋欄杆引導視線到主教座堂雙塔；直幅可加入橋上行人增加尺度', light:'上午從 Śródka 側取景可得到側光；站在橋邊而非車道中央，避開通行中的單車與行人。', mapUrl:'https://www.google.com/maps/search/?api=1&query=52.412619%2C16.951091'},
];
...
export const mapPins = {
  warsaw: {
    ...
    points: [
      ...
      [52.229002, 21.023323, "NUTA ★", "米其林一星", diningPlaces['warsaw-nuta'].map, "star1", null, 'warsaw-nuta'],
      [52.251114, 21.036166, "hub.praga ★", "米其林一星", diningPlaces['warsaw-hub-praga'].map, "star1", null, 'warsaw-hub-praga'],
  ...
  krakow: {
    ...
    points: [
      ...
      [50.048617, 19.946137, "Bottiglieria 1881 ★★", "全波蘭唯一二星", diningPlaces['krakow-bottiglieria-1881'].map, "star2", null, 'krakow-bottiglieria-1881'],
      [50.051709, 19.949426, "Bufet KRK", "必比登", diningPlaces['krakow-bufet-krk'].map, "bib", null, 'krakow-bufet-krk'],
      [50.051821, 19.945448, "Folga", "必比登", diningPlaces['krakow-folga'].map, "bib", null, 'krakow-folga'],
      [50.064873, 19.927661, "MOLÁM Thai", "必比登", diningPlaces['krakow-molam-thai'].map, "bib", null, 'krakow-molam-thai'],
      [50.051491, 19.944291, "NOAH", "必比登", diningPlaces['krakow-noah'].map, "bib", null, 'krakow-noah'],
      [50.049302, 19.943241, "Nat Bistro", "必比登", diningPlaces['krakow-nat-bistro'].map, "bib", null, 'krakow-nat-bistro'],
      [50.051748, 19.944791, "Okrąglak（Plac Nowy zapiekanka）", "使用者指定 · plac Nowy 4B", diningPlaces['krakow-okraglak-plac-nowy-圓亭'].map, "food", null, 'krakow-okraglak-plac-nowy-圓亭'],
      [50.064387, 19.942273, "Szalone Widelce", "使用者指定 · Szpitalna 40", diningPlaces['krakow-szalone-widelce'].map, "food", null, 'krakow-szalone-widelce'],
      [50.057733, 19.937930, "Bar Mleczny Pod Temidą", "使用者指定 · Grodzka 43", diningPlaces['krakow-bar-mleczny-pod-temida'].map, "food", null, 'krakow-bar-mleczny-pod-temida'],
      [50.053182, 19.947628, "Hamsa", "以色列 hummus", diningPlaces['krakow-hamsa'].map, "food", null, 'krakow-hamsa'],
  ...
  wroclaw: {
    ...
    points: [
      ...
      [51.11274, 17.031823, "BABA ★", "米其林一星", diningPlaces['wroclaw-baba'].map, "star1", null, 'wroclaw-baba'],
...
Object.assign(mapPinChecks.wroclaw, {
  ...
  // 換算 51.106944／17.076944；站內圖釘距該點約 27 m（官方只給到角秒精度，仍落在同一棟建物內）。
  '百年廳 Hala Stulecia': {status:'coordinate-verified', checkedAt:'2026-09-18', coordinateSource:'halastulecia.pl 官方公布座標（51°06′25″N 17°04′37″E）', distanceMeters:27},
...
export const attractions = {
  warsaw: [
    ...
    {name:'皇家城堡', tag:'UNESCO 舊城核心', priceNote:'2026-09-18 官網查證：二–日 10:00–18:00，最後入場 17:00、週一休館 · Castle Route 95／75（含語音導覽，約 150 分）· Royal Route 60／45（含語音導覽，約 60 分）· 週三免費，但只走皇家寓所與 Lanckoroński 畫廊的限定路線（綠廳、黃廳、大理石廳、瓷器與 Wettin 畫廊、議會廳不開），且只能個人自行參觀、不能預約，當日在售票口領票、數量有限 · 語音導覽租借 10', mapUrl:'https://maps.google.com/?cid=2313057209867159998'},
    {name:'華沙起義博物館', tag:'歷史', priceNote:'2026-09-18 官網查證：PLN 35／30 · 一 08:00–18:00、二休館、三–五 08:00–18:00、六日 10:00–18:00，售票至閉館前 30 分 · 官方明列免費日為週四（10/30 是週五，要買票）· 語音導覽租借 13／自備手機 10 · 英語導覽 250＋門票', mapUrl:'https://maps.google.com/?cid=12215511195580548645'},
    ...
    {name:'科學文化宮觀景台', tag:'地標', priceNote:'2026-09-18 官方售票系統查證：全票 30／優待 25 PLN（10 人以上團體 22）· 每日 10:00–20:00、售票口同時間 · 不接受預約，現場最多買到 7 天後 · 夜間場（35 PLN）只在週五六且官方只排到 9 月底，不套用到 10 月；11/1 閉館', mapUrl:'https://maps.google.com/?cid=14044892037721828802'},
  ...
  krakow: [
    {name:'Wawel 皇家城堡群', tag:'逐展售票', priceNote:'2026-09-17 官網查證（9–12 月）：二–日 09:00–17:00，分路線售票 · 二樓代表廳（含鄂圖曼土耳其帳篷）57／43、末入場為閉館前 50 分 · 王冠寶庫 47／35、末入場前 40 分 · Castle Underground 47／35（含語音導覽）· Armoury 47／35 · 皇家花園只開到 10/4', mapUrl:'https://maps.google.com/?cid=12446225081720350104'},
    {name:'中央市集廣場 · 紡織會館', tag:'地標', priceNote:'大型中世紀廣場（Rynek Główny）· 廣場免費', mapUrl:'https://maps.google.com/?cid=14107513768635600179'},
    {name:'Kazimierz 猶太區', tag:'街區', priceNote:'猶太會堂、餐酒館、街食聚集', mapUrl:'https://maps.google.com/?cid=5623518211080575812'},
    {name:'辛德勒工廠博物館', tag:'需訂', priceNote:'2026-09-18 官網查證：PLN 60／45 · ul. Lipowa 4 · 週一 10:00–15:00、週二–日 09:00–20:00、每月第一個週二休 · 最後入場為閉館前 90 分鐘 · 常設展線上票一律實名，入場要帶同名證件正本 · 英語個人導覽場二–日 10:00／12:00／16:00（90／75）· 週一免費、現場限量', mapUrl:'https://maps.google.com/?cid=3670197855150446585'},
    {name:'維利奇卡鹽礦', tag:'需票', priceNote:'UNESCO · Kinga 鹽教堂 · 恆溫 17–18°C · 路線 3.5 km、下探 135 m、超過 800 級階梯、全程約 2–3 h · 10/27 英語團、價格與庫存看官方日期選擇器 · 只在 bilety.kopalnia.pl 與現場售票口／售票機購票，官方聲明不與外部平台或中介合作', mapUrl:'https://maps.google.com/?cid=10891192289792865301'},
    {name:'奧斯威辛-比克瑙', tag:'只限線上取得入場證', priceNote:'10 月 07:30–17:00 · 入口不售票 · 英文導覽指定場次與票價看官方預約系統', mapUrl:'https://www.google.com/maps/search/?api=1&query=%E5%A5%A7%E6%96%AF%E5%A8%81%E8%BE%9B-%E6%AF%94%E5%85%8B%E7%91%99%20Krak%C3%B3w'},
  ],
  wroclaw: [
    {name:'小矮人 Krasnale 尋寶', tag:'免費', priceNote:'全城散布大量小銅像 · Rynek／Plac Solny／Świdnicka 一帶較集中', mapUrl:'https://maps.google.com/?cid=10632303817405446655'},
    ...
    {name:'大教堂島 Ostrów Tumski', tag:'古城', priceNote:'全城最古老城區', mapUrl:'https://maps.google.com/?cid=3827887123396229836'},
    {name:'Afrykarium · 動物園', tag:'熱門', priceNote:'2026-09-17 官方票價頁查證：全票線上 69 zł 起／售票口 99 zł，優待票線上 59 zł 起／售票口 89 zł（動態定價）· 2026-09-19 開放時間複核：10 月一–四入園至 16:00、館舍至 16:45、Afrykarium 至 17:00；五–日及假日入園至 17:00、Afrykarium 至 18:00 · 入園票已含 Afrykarium', mapUrl:'https://www.google.com/maps/search/?api=1&query=Afrykarium%20Wroc%C5%82aw'},
    ...
    {name:'百年廳 Hala Stulecia', tag:'UNESCO', priceNote:'2026-09-18 官網查證：Visitor Centre 夏季（4–10 月）二–日 10:00–18:00、冬季 10:00–17:00，25／20 · 含廳內看台 30／25 · 10 人以下不需預約。官方 availability calendar 逐日分四色（綠＝含廳內看台／藍＝部分時段廳內不開／黃＝不能進圓頂正下方／紅＝全不開），10/28 屬哪一色待確認', mapUrl:'https://maps.google.com/?cid=10763621538599936407'},
  ...
  poznan: [
    ...
    {name:'可頌博物館 Rogalowe Muzeum', tag:'場次制展演', priceNote:'2026-09-18 官網查證：英語公開場 47 PLN／人（滿 3 歲起）、未滿 3 歲 1 PLN；官方售票頁列日–五 11:00–15:30、六 11:00–17:00（官方註明是第一場與最後一場開演時間），入口 Klasztorna 23、館內約 50 人。10/29 有無英語場與開演時刻仍看官方售票頁，不要預設 13:30 有場', mapUrl:'https://maps.google.com/?cid=402526412385617111'},
    ...
    {name:'帝王城堡 Zamek Cesarski', tag:'地標', priceNote:'2026-09-17 官網查證：CK ZAMEK 文化中心，一–日 12:00–19:00、售票至 18:00 · 附地圖摺頁自行參觀 10／7 PLN、語音導覽 20／15 PLN，導覽機 18:00 前發放、19:00 前歸還 · 室內可參觀空間仍依當日活動公告', mapUrl:'https://www.google.com/maps/search/?api=1&query=%E5%B8%9D%E7%8E%8B%E5%9F%8E%E5%A0%A1%20Zamek%20Cesarski%20Pozna%C5%84'},
    ...
    {name:'Palmiarnia 棕櫚屋', tag:'暫時閉館', priceNote:'2026-09-18 再次複查公告未變（原查 2026-09-17）：因現代化與改建工程對外暫時閉館，官方未公布重開日期（公告見 palmiarnia.poznan.pl，另指向 pim.poznan.pl）。行程期間無法入內，也不要當雨天室內備案', mapUrl:'https://maps.google.com/?cid=10703456143872687277'},
    {name:'考古博物館', tag:'室內', priceNote:'2026-09-18 官方票價頁查證：常設展全票 15／優待 10、家庭票 40，與 Genius loci 的聯票 25／15 · 官方每週二免費（10/29 是週四，要買票）· 學期季（9/1–6/30）二–四 09:00–16:00、五 10:00–17:00、六 11:00–18:00、日 12:00–16:00', mapUrl:'https://www.google.com/maps/search/?api=1&query=%E8%80%83%E5%8F%A4%E5%8D%9A%E7%89%A9%E9%A4%A8%20Pozna%C5%84'},
