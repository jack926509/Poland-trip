...
export const attractions = {
  ...
  krakow: [
    ...
    {name:'維利奇卡鹽礦', tag:'需票', priceNote:'UNESCO · Kinga 鹽教堂 · 恆溫 17–18°C · 10/27 英語團、價格與庫存看官方日期選擇器', mapUrl:'https://maps.google.com/?cid=10891192289792865301'},
  ...
  wroclaw: [
    ...
    {name:'百年廳 Hala Stulecia', tag:'UNESCO', priceNote:'Visitor Centre 四–十月二–日 10:00–18:00，25／20 · 含廳內 30／25。官方 availability calendar 逐日分三態（可進圓頂／只開 Visitor Centre／全不開），10/28 屬哪一態待確認', mapUrl:'https://maps.google.com/?cid=10763621538599936407'},
  ...
  poznan: [
    ...
    {name:'可頌博物館 Rogalowe Muzeum', tag:'場次制展演', priceNote:'2026-09-17 官網查證：英語公開場 47 PLN／人（滿 3 歲起）、未滿 3 歲 1 PLN；官網列日–四 11:00–15:30、六 11:00–17:00（未列週五），入口 Klasztorna 23、館內約 50 人。10/29 有無英語場與開演時刻仍看官方售票頁，不要預設 13:30 有場', mapUrl:'https://maps.google.com/?cid=402526412385617111'},
    ...
    {name:'Palmiarnia 棕櫚屋', tag:'暫時閉館', priceNote:'2026-09-17 官網查證：因現代化與改建工程對外暫時閉館，官方未公布重開日期（公告見 palmiarnia.poznan.pl，另指向 pim.poznan.pl）。行程期間無法入內，也不要當雨天室內備案', mapUrl:'https://maps.google.com/?cid=10703456143872687277'},
    {name:'考古博物館', tag:'室內', priceNote:'2026-09-17 官網查得學期季（9/1–6/30）開放時間：二–四 09:00–16:00、五 10:00–17:00、六 11:00–18:00、日 12:00–16:00。票價分頁本次讀取失敗，站內舊值 10／6 與外傳的 15／10 互相矛盾且均無一手佐證，票價與免費日一律待重查', mapUrl:'https://www.google.com/maps/search/?api=1&query=%E8%80%83%E5%8F%A4%E5%8D%9A%E7%89%A9%E9%A4%A8%20Pozna%C5%84'},
