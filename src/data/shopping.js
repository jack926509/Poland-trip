...
export const luxuryShopping = [
  {shop:'Vitkac', city:'華沙', note:'中東歐最大精品百貨，Gucci／Balenciaga／Saint Laurent／Burberry 等；週日休', mapUrl:'https://maps.google.com/?cid=6893272886103886879'},
  {shop:'Chylak（Le Petit Trou）', city:'華沙', note:'波蘭設計師精品包款，Koszykowa 街；Mokotowska 街區另有多家波蘭獨立設計師精品店可順路逛', mapUrl:'https://maps.google.com/?cid=2015234439722332980'},
];

export const souvenirShops = [
  {city:'克拉科夫', name:'Stradomska 街 Bolesławiec 陶器店', note:'陶器店集中在 Stradomska 街，如 23 號', mapUrl:'https://www.google.com/maps/search/?api=1&query=Stradomska%20Street%20pottery%20shops%20Krak%C3%B3w'},
  {city:'克拉科夫', name:'S&A Amber', note:'Grodzka 街 60／14 號；認 handmade／產地標避免仿品', mapUrl:'https://www.google.com/maps/search/?api=1&query=S%26A%20Amber%20Grodzka%20Krak%C3%B3w'},
  {city:'克拉科夫', name:'World of Amber', note:'克拉科夫琥珀店備選', mapUrl:'https://www.google.com/maps/place/?q=place_id:ChIJPxlI8hJbFkcR7vI2ebLVIDk'},
  {city:'克拉科夫', name:'Sukiennice 布廊', note:'廣場內伴手禮攤位集中', mapUrl:'https://www.google.com/maps/search/?api=1&query=Sukiennice%20Cloth%20Hall%20Krak%C3%B3w'},
