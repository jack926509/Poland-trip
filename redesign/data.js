...
window.TRIP = {
  ...
  days: [
    ...
    },
    {
      ...
      steps: [
        ...
        {t:'17:00', label:'取行李，自由活動或補拍照', dur:'1 h'},
        {t:'18:00', label:'取行李 → Bolt 到 Kraków Główny', cost:'PLN 15'},
  ...
  cityFood: [
    {city:'華沙', en:'Warszawa', items:[
      ...
      {tag:'河畔酒吧', name:'Plażа Poniatówka', note:'維斯瓦河畔沙灘酒吧，日落後氣氛佳', book:'walk'},
      {tag:'猶太料理', name:'Beit Warszawa 周邊小館', note:'POLIN 附近，可接續博物館主題', book:'walk'},
  ...
  reservations: [
    ...
    {when:'出發前 30 天（約 9/23 起）', what:'PKP Intercity Super Promo 開賣，鎖定四段火車車票（含 Day4 KRK→WRO 19:30 班次，intercity.pl）；開賣當週密集比價，越早訂越便宜'},
