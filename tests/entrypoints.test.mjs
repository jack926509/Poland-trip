...
test('根入口依 768 px 與 view query 分流桌機雜誌和既有手機 PWA', () => {
  ...
  assert.match(html, /redesign\/pwa-core\.js\?v=polska-v17/);
  assert.match(html, /pwa-register\.js\?v=polska-v17/);
